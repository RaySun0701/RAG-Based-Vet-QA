...
# Input and output file paths (relative to project structure)
INPUT_FILE = os.path.join(BASE_DIR, "../vet_knowledge/merck_knowledge.jsonl")
OUTPUT_FILE = os.path.join(BASE_DIR, "../vet_corpus/chunked_merck.jsonl")
