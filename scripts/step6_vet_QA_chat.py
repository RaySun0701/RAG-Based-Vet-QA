...
QWEN_MODEL_PATH = os.path.join(PROJECT_ROOT, "qwen_0.5b")
BGE_MODEL_PATH = os.path.join(PROJECT_ROOT, "bge_retriever")
INDEX_DIR = os.path.join(PROJECT_ROOT, "vet_local_embedding")
